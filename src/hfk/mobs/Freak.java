	...
	public Freak(PointF pos, LoadOutType t) {
		...
		switch(t){
			case pistol:
				...
				inventory.equipWeapon(new Pistol(0f, pos.clone()));
			...
			case shotgun:
				...
				inventory.equipWeapon(new DoubleBarrelShotgun(0f, pos.clone()));
				inventory.addAmmo(Weapon.AmmoType.shell, GameController.random.nextInt(21) + 10);
				break;
			case energypistol:
				barrageTimeOnHit = 2000;
				barrageTimeOnLost = 1000;
				inventory.equipWeapon(new EnergyPistol(0f, pos.clone()));
				inventory.addAmmo(Weapon.AmmoType.bullet, GameController.random.nextInt(41) + 30);
				break;
			case plasmaminigun:
				...
				inventory.equipWeapon(new PlasmaMachinegun(0f, pos.clone()));
