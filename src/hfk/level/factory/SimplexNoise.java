...
/**
 * @author Stefan Gustavson, Peter Eastman
 */

/*
 * I have modified the code a bit, but it still is near the original
 */
...
public class SimplexNoise {  // Simplex noise in 2D, 3D and 4D
  ...
  public static PointF getRandomOffset(){
	  PointF p = PointF.createRandom();
	  p.multiply(1000f);
	  return p;
  }
