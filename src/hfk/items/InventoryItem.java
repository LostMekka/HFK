...
public abstract class InventoryItem implements StatsModifier {
	...
	public void render(){
		if(image != null){
			GameController.get().renderer.drawImage(image, pos, 1f, angle, true, GameRenderer.LayerType.items);
		}
	}
